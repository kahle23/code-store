...
//     public static void setBase64Encoder(Object base64) {
//         Assert.notNull(base64, "Parameter \"base64\" must not null. ");
//     }

//     public static void setHexEncoder(Object hex) {
...
//         return CodecUtils.encodeToString(HEX, key.getEncoded());
//     }

//     public static String toBase64String(Key key) {

//         return CodecUtils.encodeToString(BASE64, key.getEncoded());
//     }
