...
/**
 * The ding talk robot. 迁移自 misaka-extend 的 misaka.alibaba.dingtalk.DingTalkRobot
 * （artoria.codec.Base64Utils 在新版 artoria 中不存在，改由 JDK java.util.Base64 实现签名编码）。
 * @author Kahle
 */
public class DingTalkRobot implements MessageBot {
    ...
    protected String sign(Long timestamp, String secret) {
        try {
            ...
            String base64Str = java.util.Base64.getEncoder().encodeToString(digest);
