...
import kunlun.message.MessageProvider;
...
public abstract class AbstractMessageProvider implements MessageProvider {
    ...
    protected final Map<String, kunlun.message.MessageHandler> messageHandlers;
    protected final Map<String, Object> commonProperties;

    protected AbstractMessageProvider(Map<String, Object> commonProperties,
                                      Map<String, kunlun.message.MessageHandler> messageHandlers) {
    ...
    public AbstractMessageProvider() {
        this(new ConcurrentHashMap<String, Object>(),
                new ConcurrentHashMap<String, kunlun.message.MessageHandler>());
    }

    protected kunlun.message.MessageHandler getMessageHandlerInner(String handlerName) {
        Assert.notBlank(handlerName, "Parameter \"handlerName\" must not blank. ");
        kunlun.message.MessageHandler messageHandler = messageHandlers.get(handlerName);
    ...
    @Override
    public void registerHandler(String handlerName, kunlun.message.MessageHandler messageHandler) {
    ...
    public void deregisterHandler(String handlerName) {
        Assert.notBlank(handlerName, "Parameter \"handlerName\" must not blank. ");
        kunlun.message.MessageHandler remove = messageHandlers.remove(handlerName);
        if (remove != null) {
