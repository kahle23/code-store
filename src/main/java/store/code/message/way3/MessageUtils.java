...
import kunlun.message.SimpleMessageProvider;
...
public class MessageUtils {
    ...
    private static volatile kunlun.message.MessageProvider messageProvider;

    public static kunlun.message.MessageProvider getMessageProvider() {
    ...
    public static void registerHandler(String handlerName, kunlun.message.MessageHandler messageHandler) {
