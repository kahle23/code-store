...
import kunlun.message.support.mq.rocketmq.RocketMqMessage;
...
public class RocketMqMessageHandler extends AbstractClassicMessageHandler {
    ...
    protected Message convert(Object input) {
        ...
        else if (input instanceof kunlun.message.support.mq.rocketmq.RocketMqMessage) {
            kunlun.message.support.mq.rocketmq.RocketMqMessage mqMessage = (RocketMqMessage) input;
