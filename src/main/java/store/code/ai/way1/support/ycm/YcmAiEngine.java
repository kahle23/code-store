package store.code.ai.way1.support.ycm;

import store.code.ai.way1.support.AiMessage;
...
/**
 * 基于鱼聪明AI接口封装的AI引擎.
 * 迁移自 misaka-extend 的 misaka.ai.llm.support.ycm.YcmAiEngine，已改写为独立实现
 * （原依赖 artoria.ai.AbstractClassicAiEngine / artoria.ai.llm.LLM，该 API 在 code-store 锁定的
 * artoria 版本中不存在）。
 * @see <a href="https://github.com/liyupi/yucongming-java-sdk">鱼聪明 Java SDK</>
 * @author Kahle
 */
public class YcmAiEngine {
