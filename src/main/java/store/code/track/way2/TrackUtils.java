...
public class TrackUtils {
    ...
    private static volatile kunlun.track.TrackProvider trackProvider;

    public static kunlun.track.TrackProvider getTrackProvider() {
    ...
    public static void setTrackProvider(kunlun.track.TrackProvider trackProvider) {
